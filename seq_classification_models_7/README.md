...
با لیستی از این تاپل ها ، خود کلاس لیستی از ترنسفورمر ها رو میسازه و خروجی برمیگردونه. اون لیستو میشه ورودی مدل داد!  
در ضمن این کارها توی متد Train-Method انجام شده، تنها کادی که باید کرد اینه که لیست تاپل ها رو ورودی بدید.   
