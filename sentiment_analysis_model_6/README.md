...
### Results
###### نتایج train های انجام شده روی دیتاست های بسیار کوچک در جدول زیر مشخص است. در6 Lab هر چهار مدل رو روی دیتاست خیلی کوپکی اموزش داده ایم. در هر اموزش پارامتر ها را تغییر داده ایم تا تاثیر پارامتر های مختلف را بر عملکرد مدل ببینیم. همچنین در این حین میتوان در هر Lab هر چهار مدل را نیز با هم مقایسه کرد.
