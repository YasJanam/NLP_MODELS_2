...
---
### 🔴 اشکالات !!
##### 🔺 گزارش پایین (بعد از ذکر اشکالات) رو قبل از اینکه متوجه اشکالات بشم نوشتم، ولی پاک نمیکنم تا نشخه اصلی کد با تحلیلش بمونه !
...
##### 🔺 اندازه max_length رو در کد برابر 512 گذاشتیم در حالی که حداکثر طول تکست در دیتاست استفاده شده (20 کلاسه) برابر 93 هست !! این یعنی اکثر دیتا padding بوده و مدل padding ها رو یاد میگرفته !!

##### 🔹 لینک کد اصلاح شده: https://github.com/YasJanam/NLP_MODELS_2/tree/main/seq_classification_models_7
